...
class TestTransactionParser(unittest.TestCase):
    def test_transaction_parsing_v3(self):
        ...
        v3_transactions: list = [
            {
                "version": "0x3",
                "from": "hx6e1dd0d4432620778b54b2bbc21ac3df961adf89",
                "to": "cx0000000000000000000000000000000000000001",
                "stepLimit": "0x70000000",
                "timestamp": "0x592401ffd2d8e",
                "nid": "0x50",
                "dataType": "deploy",
                "data": {
        ...
        for transaction in v3_transactions:
            actual_txhash: bytes = TransactionParser.get_tx_hash_key_from_transaction(
                transaction
            )
        ...
        v2_transactions: list = [
            {
                ...
                "to": "hxe2fac977efc0318d6cf52646611e285614b2a196",
                "value": "0x30ca024f987b900000",
                "fee": "0x2386f26fc10000",
                "timestamp": "1524482271584000",
    ...
    def test_transaction_parsing_genesis(self):
        ...
        for transaction in genesis_transactions:
            actual_txhash = TransactionParser.get_tx_hash_key_from_transaction(
                transaction
            )
