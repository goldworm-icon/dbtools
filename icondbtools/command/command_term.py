...
class CommandTerm(Command):
    ...
    def add_parser(self, sub_parser, common_parser):
        ...
        parser_term.add_argument('--height', type=int, default=-1, help='target block height', required=False)
    ...
    def run(self, args):
        ...
        if height > -1:
            ...
            print(f'Decentralization info of the block and period the block belongs to for only MainNet\n'
